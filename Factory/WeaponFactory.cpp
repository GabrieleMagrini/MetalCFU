...
std::unique_ptr<Weapon> WeaponFactory::createWeapon(WeaponType w) {
    ...
    switch (w) {
        ...
        case WeaponType::M4 :
            result = std::unique_ptr<Weapon>(
                    new Weapon{45, 40, 20, 300, "Sources/Pngs/weapon textures/sheetM4.png", "M4", 0.10f});
            break;
        ...
        case WeaponType::INV:
            result = std::unique_ptr<Weapon>(
                    new Weapon{45, 40, 20, 300, "Sources/Pngs/weapon textures/Invisible_WEAPON.png", "INV", 0.20f});
            break;
    }
    return result;
}